...
.PHONY: pr-review-snapshot
pr-review-snapshot:
	$(PYTHON) scripts/pr_review_snapshot.py --root $(ROOT) --repo Orxaq/orxaq-ops --repo Orxaq/orxaq --output $(ROOT)/artifacts/autonomy/pr_review_snapshot.json --markdown $(ROOT)/artifacts/autonomy/pr_review_snapshot.md --json
